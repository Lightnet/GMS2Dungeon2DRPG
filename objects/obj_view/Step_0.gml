...
if(bcameracontrol){
    ...
    {
        if (mouse_x > x + (0.5*view_wport) - 10 || mouse_x < x - (0.5*view_wport) + 10 || mouse_y > y + (0.5*view_hport) - 10 || mouse_y < y - (0.5*view_hport) + 10)
        {
        ...
        if(mouse_x > x + (0.5*view_wport))
        {
            display_mouse_set(x + (0.5*view_wport), mouse_y);
        }
        if(mouse_x < x - (0.5*view_wport))
        {
            display_mouse_set(x - (0.5*view_wport), mouse_y);
        }
        if(mouse_y > y + (0.5*view_hport))
        {
            display_mouse_set(mouse_x, y + (0.5*view_hport));
        }
        if(mouse_y < y - (0.5*view_hport))
        {
            display_mouse_set(mouse_x, y - (0.5*view_hport));
